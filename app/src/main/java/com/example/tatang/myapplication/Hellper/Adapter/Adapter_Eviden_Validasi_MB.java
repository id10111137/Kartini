...
//import com.example.tatang.myapplication.MainHomes.Eviden.Validasi.Activity_Validasi_GM_Detail;
...
// */
//
//public class Adapter_Eviden_Validasi_MB extends ArrayAdapter<ModelValidasiMB> {
//
...
//    }
//
//    public Adapter_Eviden_Validasi_MB(ArrayList<ModelValidasiMB> data, Context context) {
...
//                Intent intent = new Intent(getContext(), Activity_Validasi_GM_Detail.class);
